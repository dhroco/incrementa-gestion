# legal-rep-signature Specification

## Purpose
Imagen PNG de rúbrica del representante legal de la empresa: tabla, API de subida/borrado, URLs firmadas en el detalle y UI en la ficha de empresa.
