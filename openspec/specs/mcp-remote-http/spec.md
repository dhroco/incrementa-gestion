# mcp-remote-http Specification

## Purpose
Remote MCP server exposed via Streamable HTTP on Cloud Run pre-prod for Claude Desktop and Claude.ai clients. Intentionally unauthenticated in this phase; OAuth per user is planned for production.
