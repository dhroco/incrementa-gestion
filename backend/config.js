...
const config = {
  local: {
    ...
    GRAPH_TENANT_ID: process.env.GRAPH_TENANT_ID || '60322b4a-13bf-4f19-89ae-efe4a54ffed6',
    GRAPH_CLIENT_ID: process.env.GRAPH_CLIENT_ID || 'dc734f4a-5f25-4e88-b728-aab4715f2122',
