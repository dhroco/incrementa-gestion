/**
 * Otorga al Usuario empresa administrador lectura sobre cláusulas universales
 * y templates estándar (entradas de menú y acciones READ), alineado con
 * 002_navigation_authorization_seed. Idempotente.
 */
const CODES = [
